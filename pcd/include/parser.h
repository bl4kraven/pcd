...
#define PCD_PARSER_KEYWORDS \
    ...
    PCD_PARSER_KEYWORD( ALIVE_TIMEOUT,     	0 )\
    PCD_PARSER_KEYWORD( FAILURE_ACTION,     1 )\
    PCD_PARSER_KEYWORD( FAILURE_ACTION2,    0 )\
    PCD_PARSER_KEYWORD( FAILURE_ACTION_NEXT,0 )\
    PCD_PARSER_KEYWORD( FAILURE_INTERVAL,   1 )\
    PCD_PARSER_KEYWORD( FAILURE_RESET_COUNT,1 )\
