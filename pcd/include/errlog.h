...
#define PCD_ERRLOG_MAX_FILE_SIZE        ( 64*1024 )

/*! \enum pcdRuleState_e
 *  \brief Rule Log Status enumeration
 */
typedef enum
{
	PCD_LOGSTATUS_NONE = 0,    /* Log is NONE   		0 */
    PCD_LOGSTATUS_RESTART,     /* Log is START/RESTART  1 */
	PCD_LOGSTATUS_NODEF_2,     /* NOT DEFINED   		2 */
	PCD_LOGSTATUS_FAILED,      /* Log is CRASH  		3 */
	PCD_LOGSTATUS_HUNG,        /* Log is STUCK  		4 */
	PCD_LOGSTATUS_FAULTY,      /* Log is FAULTY 		5 */
